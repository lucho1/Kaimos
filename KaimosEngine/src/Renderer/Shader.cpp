...
namespace Kaimos {
	...
	Shader::Shader(const std::string& vertexSrc, const std::string& fragmentSrc)
	{
		...
		if (isCompiled == GL_FALSE)
		{
			...
			KS_ENGINE_ASSERT(false, "Vertex Shader Compilation Failure!");
			return;
		}
		...
		if (isCompiled == GL_FALSE)
		{
			...
			// Use the infoLog to print error & assert
			KS_ENGINE_CRITICAL("FShader Compilation Error: {0}", infoLog.data());
			KS_ENGINE_ASSERT(false, "Fragment Shader Compilation Failure!");
			return;
		}
