...
namespace Kaimos::MaterialEditor {
	...
	void MainMaterialNode::DrawNodeUI()
	{
		...
		if (PBR_Pipeline)
		{
			...
			DrawFloatPin(set_node_draggable, m_RoughnessPin, m_AttachedMaterial->Roughness, 0.00f, 1.0f);
			...
			DrawFloatPin(set_node_draggable, m_MetallicPin, m_AttachedMaterial->Metallic, 0.00f, 1.0f);
			...
			DrawFloatPin(set_node_draggable, m_AmbientOcclusionPin, m_AttachedMaterial->AmbientOcclusion, 0.01f, 1.0f);
